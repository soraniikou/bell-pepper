                  ...
                  <svg width="360" height="360" viewBox="-180 -180 360 360" style={{ overflow: "visible" }}>
                    ...
                    <defs>
                      <radialGradient id="petalGradWhite" cx="45%" cy="30%">
                        <stop offset="0%" stopColor="hsla(345, 50%, 92%, 0.99)" />
                        <stop offset="30%" stopColor="hsla(345, 45%, 88%, 0.97)" />
                        <stop offset="70%" stopColor="hsla(340, 40%, 84%, 0.93)" />
                        <stop offset="100%" stopColor="hsla(335, 35%, 78%, 0.85)" />
                      </radialGradient>
                      {petalAngles.map((_, i) => {
